  ...
  const doctors = [
 {
  ...
  return (
    <div className="bg-zinc-50 dark:bg-black dark:text-white">
      ...
      {/* HERO SECTION */}
      <section className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-20 text-center px-6">
        <h1 className="text-4xl md:text-5xl font-bold">
          Meet Our Medical Experts
        </h1>
        <p className="mt-4 max-w-2xl mx-auto text-blue-100">
          Our experienced and compassionate doctors are dedicated to delivering
      ...
      <section className="max-w-6xl mx-auto px-8 py-20 text-center">
        <h2 className="text-3xl font-bold">Our Specialists</h2>

        <div className="grid md:grid-cols-3 gap-8 mt-12">
          {doctors.map((doc, index) => (
            <div
              key={index}
              className="p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-md hover:shadow-xl transition"
            >
              <div className="text-5xl">👨‍⚕️</div>
              <h4 className="mt-4 text-xl font-semibold">{doc.name}</h4>
              <p className="text-blue-600">{doc.specialty}</p>
              <p className="mt-3 text-sm text-zinc-600 dark:text-zinc-400">
                Providing professional and patient-centered medical care.
              </p>
      ...
      <section className="bg-white dark:bg-zinc-900 py-20">
        <div className="max-w-6xl mx-auto px-8 text-center">
          <h2 className="text-3xl font-bold">Why Choose Our Doctors?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            ...
            <div>
              ...
              <p className="mt-2 text-zinc-600 dark:text-zinc-400">
                Focused on patient comfort and personalized treatment.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-zinc-600 dark:text-zinc-400">
                Modern diagnostic tools for accurate results.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 max-w-6xl mx-auto px-8 text-center">
        ...
        <div className="grid md:grid-cols-4 gap-6 mt-12">
          {[
            ...
            <div
              key={i}
              className="bg-zinc-100 dark:bg-zinc-800 p-6 rounded-xl hover:shadow-md transition"
            >
              {item}
            </div>
          ))}
        ...
        <div className="max-w-6xl mx-auto px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div>
              ...
              <h4 className="mt-4 font-semibold">Choose a Doctor</h4>
            ...
            <div>
              <div className="text-4xl">🏥</div>
              <h4 className="mt-4 font-semibold">Receive Care</h4>
              <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                Visit the clinic and get expert treatment.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-blue-600 text-white text-center">
        <h2 className="text-3xl font-bold">Patient Testimonials</h2>

        <div className="max-w-4xl mx-auto mt-12 grid md:grid-cols-2 gap-8 px-8">
          <div className="bg-blue-500 p-6 rounded-xl">
            <p>
              “The cardiology team provided excellent care and attention.”
            </p>
            <h4 className="mt-4 font-semibold">— James K.</h4>
          </div>

          <div className="bg-blue-500 p-6 rounded-xl">
            <p>
              “Very friendly pediatrician. My kids felt comfortable and safe.”
            </p>
            <h4 className="mt-4 font-semibold">— Maria L.</h4>
          </div>
        </div>
      </section>
